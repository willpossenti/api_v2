...
app.factory('authService', ['$http', '$q', 'localStorageService', 'ngAuthSettings', function ($http, $q, localStorageService, ngAuthSettings) {
    ...
    var _login = function (loginData) {
        ...
        $http.post(serviceBase + 'authenticate', JSON.stringify(data), { headers: { 'Content-Type': 'application/json' } }).then(function successCallback (response) {

            var arrayResponse = [];
            arrayResponse = angular.fromJson(response.data);
