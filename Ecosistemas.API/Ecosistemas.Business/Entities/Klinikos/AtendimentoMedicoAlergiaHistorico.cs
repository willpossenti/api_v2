...
{
    public class AtendimentoMedicoAlergiaHistorico
    {

        [Key]
        public Guid AtendimentoMedicoAlergiaHistoricoId { get; set; }

        public virtual AtendimentoMedicoAlergia AtendimentoMedicoAlergia { get; set; }
